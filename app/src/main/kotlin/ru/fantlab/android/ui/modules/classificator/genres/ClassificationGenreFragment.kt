...
class ClassificationGenreFragment : BaseFragment<ClassificationGenreMvp.View, ClassificationGenrePresenter>(),
		ClassificationGenreMvp.View {
	...
	fun onSetTabCount(count: Int) {
		pagerCallback?.onSetBadge(0, count)
	}
