...
class AutoLinearLayout : FrameLayout {
	...
	private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
		val a = context.obtainStyledAttributes(attrs, R.styleable.AutoLinearLayout, defStyleAttr, defStyleRes)
		try {
	...
	private fun measureHorizontal(widthMeasureSpec: Int, heightMeasureSpec: Int) {
		...
		setMeasuredDimension(View.resolveSize(wSize, widthMeasureSpec),
				View.resolveSize(totalHeight + paddingTop + paddingBottom, heightMeasureSpec))
	}
	...
	private fun measureVertical(widthMeasureSpec: Int, heightMeasureSpec: Int) {
		...
		setMeasuredDimension(View.resolveSize(totalWidth + paddingRight + paddingLeft,
				widthMeasureSpec), View.resolveSize(hSize, heightMeasureSpec))
	}
	...
	private fun layout(child: View, pos: ViewPosition) {
		...
		if (mOrientation == HORIZONTAL)
			child.layout(pos.left, pos.top + lp.topMargin, pos.left + child.measuredWidth, pos.top +
					child.measuredHeight + lp.topMargin)
		else
			child.layout(pos.left + lp.leftMargin, pos.top, pos.left + child.measuredWidth +
	 ...
	 * See [Gravity]
	 */
	private fun setGravity(_gravity: Int) {
	 ...
	 */
	private class ViewPosition internal constructor(internal var left: Int, internal var top: Int, internal var position: Int //row or column
	) {
