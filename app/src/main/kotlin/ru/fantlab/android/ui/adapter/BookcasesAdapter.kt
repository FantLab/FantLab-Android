...
class BookcasesAdapter constructor(bookcases: ArrayList<Bookcase>)
    : BaseRecyclerAdapter<Bookcase, BookcaseViewHolder, BaseViewHolder.OnItemClickListener<Bookcase>>(bookcases) {
