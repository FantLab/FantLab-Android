...
data class FragmentPagerAdapterModel(
	...
	companion object {
		...
		fun buildForProfile(context: Context, login: String): MutableList<FragmentPagerAdapterModel> {
			return mutableListOf(
					FragmentPagerAdapterModel(context.getString(R.string.overview), /*ProfileOverviewFragment.newInstance(login)*/NewsFragment()),
